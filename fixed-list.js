...
var FixedList = (function invocation() {
    ...
    function deletePage(isPre, isLast) {
        ...
        if (isPre) {
            ...
            if (isLast) {
                console.log(parseInt(length / unit) * unit);
